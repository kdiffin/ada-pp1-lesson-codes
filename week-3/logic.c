...
int main(void) {
    ...
    printf("%d\n greater than 18: ", age > 18); // This will print 0 because age is not greater than 18
    printf("%d\n less than 18: ", age < 18); // This will print 0 because age is not less than 18
    ...
    // in this case nothing will be printed because age is not greater than 18, so the if statement will not be executed
    if (age > 18) {
        printf("You are older than 18\n");
    }
